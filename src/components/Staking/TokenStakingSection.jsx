...
const SOLANA_HOST = "https://mainnet.helius-rpc.com/?api-key=ad83cc9c-52a4-4ad4-8b6e-d96fd392c9d5";//clusterApiUrl("devnet");//clusterApiUrl("devnet");clusterApiUrl("mainnet-beta");//"https://rpc.ankr.com/solana";//
